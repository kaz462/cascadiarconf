...
3. make new tools: see repetitions in work as opportunities to improve efficiency.
...
::: notes
p1. useful for "often-used" graphs but
- lack of flexibility
- learning curve, require good documentation, heavily reply on internal expert

P2. Creative Building Bricks-ggplot2: intuitive and layered grammar of graphics approach
- easier to create complex visualizations with relatively concise code.
...
p3. The R Graph Gallery/ `falcon`/`nest` TLG Catalog under pharmaverse
:::
